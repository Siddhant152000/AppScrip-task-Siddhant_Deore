...
const NavbarSection = () => {
  const isDesktopView = window.innerWidth >= 992; // Define the breakpoint for desktop view
      ...
      <Navbar className="bg-light navbar-size" expand="lg">
        <Container>
          ...
          <Navbar.Collapse id="navbar-nav">
            ...
            <Nav className="ms-auto">
              {isDesktopView ? (
                <div className="icons"> {/* Show icons before language dropdown in desktop view */}
                  <Nav.Link href="#search">
                    <i className="fas fa-search fa-lg" />
                  </Nav.Link>
                  <Nav.Link href="#fav">
              ...
              {!isDesktopView ? (
                <div className="icons"> {/* Show icons after language dropdown in mobile view */}
                  <Nav.Link href="#search">
                    <i className="fas fa-search fa-lg" />
                  </Nav.Link>
                  <Nav.Link href="#fav">
